...
```
#### Important Parameters Options
Similiar to ["Run linear regression experiment"](#run-linear-regression-experiment), except for a few different parameters.

`--priv_unit_g_p`: the private unit g used in local DP experiment. 
