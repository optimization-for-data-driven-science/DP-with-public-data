...
class LinearRegDatasetExp(Dataset):
    def __init__(self, args, is_train=True):
        self.device = args.device
        self.data_dir = os.path.join(args.data_dir, 'LINEAR_REG', 'Experiment')
        ...
        if os.path.exists(self.X_file):
            ...
            if is_train:
                ...
                # self.theta = torch.ones((1, args.linear_reg_p), device=args.device)
            else:
            ...
            self.X = torch.zeros((self.size, args.linear_reg_p))
